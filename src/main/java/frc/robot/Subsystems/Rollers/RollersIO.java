...
public interface RollersIO {
    ...
    public static class RollersIOInputs{
        ...
        public double roller2Current = 0;
        public double roller2Temp = 0;
        public double roller2RPS = 0;
        public double roller2Voltage = 0;
    }

    public default void updateInputs(RollersIOInputs rollersIOinputs){}
    public default void requestVoltage(double setpointVolts){}
    public default void requestVelocity(double RPS){}
