...
public class intakeConstants {
    ...
    /* Current Limits */
    public static final double pivotCurrentLimit = 50; // lowered from 70, pivot doesn't need much
    public static final double pivotStatorCurrentLimit = 80; // stator limit for pivot
    public static final double intakeCurrentLimit = 140; // lowered from 140

    /* Gear Ratios */
    public static final double gearRatio = 28.57;
